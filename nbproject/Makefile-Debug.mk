...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/dobble_server

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/dobble_server: ${OBJECTFILES}
...
${OBJECTDIR}/clients.o: clients.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/clients.o clients.c
...
${OBJECTDIR}/network_stuff.o: network_stuff.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/network_stuff.o network_stuff.c
